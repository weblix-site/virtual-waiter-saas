...
@Component
public class PaynetProvider implements PaymentProvider {
  private static final ObjectMapper MAPPER = new ObjectMapper();
  private final String webhookSecret;

  public PaynetProvider(@Value("${app.payments.paynet.webhookSecret:}") String webhookSecret) {
  ...
  public ProviderCreateResult create(PaymentIntent intent) {
    throw new UnsupportedOperationException("Paynet provider not configured");
  }

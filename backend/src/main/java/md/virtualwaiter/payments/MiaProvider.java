...
@Component
public class MiaProvider implements PaymentProvider {
  private static final ObjectMapper MAPPER = new ObjectMapper();
  private final String webhookSecret;

  public MiaProvider(@Value("${app.payments.mia.webhookSecret:}") String webhookSecret) {
  ...
  public ProviderCreateResult create(PaymentIntent intent) {
    throw new UnsupportedOperationException("MIA provider not configured");
  }
